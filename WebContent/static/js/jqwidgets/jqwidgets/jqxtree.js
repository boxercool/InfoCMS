					...
					a.jqx._jqxTree.prototype,
					{
						defineInstance : function() {
							var b = {
								...
								events : [ "expand", "collapse", "select",
										"initialized", "added", "removed",
										"checkChange", "dragEnd", "dragStart",
										"itemClick" ],
								aria : {
						...
						createInstance : function(c) {
							...
							this.propertyChangeMap.disabled = function(f, h, g,
									j) {
								if (b.disabled) {
									b.host
											.addClass(b
													.toThemeProperty("jqx-tree-disabled"))
								} else {
									b.host
											.removeClass(b
													.toThemeProperty("jqx-tree-disabled"))
						...
						_getMatches : function(e, f) {
							...
							a.each(c, function(j) {
								...
								var h = a.jqx.string.startsWithIgnoreCase(k
										.toString(), e);
								if (h) {
									g.push({
										id : this.id,
													...
													if (b.selectedItem != null) {
														...
														if (b.incrementalSearch
															...
															if ((s == 8 || s == 46)
																...
																b._searchString = b._searchString
																		.substr(
																				0,
																				b._searchString.length - 1)
															}
															...
															if ((s >= 65 && s <= 97)
																...
																if (s != 8
																		&& s != 32
																		&& s != 46) {
																	if (!(b._searchString.length > 0 && b._searchString
																			.substr(
																					0,
																					1) == h)) {
																		b._searchString += h
															...
															if ((s == 39 && !b.rtl)
																...
																if (b.selectedItem.hasItems) {
																	if (!b.selectedItem.isExpanded) {
																		...
																		var c = b
																				._nextVisibleItem(b.selectedItem);
																		if (c != null) {
																			b
																					.selectItem(
																							c.element,
														...
														case 38:
															var p = b
																	._prevVisibleItem(b.selectedItem);
															if (p != null) {
																b
																		.selectItem(
																				p.element,
						...
						refresh : function(c) {
							...
							if (this.panel) {
								if (this.width != null
									...
									b.removeHandler(a(window), "resize.jqxtree"
											+ b.element.id);
									b.addHandler(a(window), "resize.jqxtree"
											+ b.element.id, function() {
										b._calculateWidth()
									})
								} else {
									this.panel.jqxPanel("width", this.host
											.width())
								}
						...
						_parseItem : function(n) {
							...
							if (this.displayMember != undefined
									&& this.displayMember != "") {
							...
							if (n.items) {
								...
								if (this.itemsMember != undefined
										&& this.itemsMember != "") {
									if (n[this.itemsMember]) {
										g += this
												.loadItems(n[this.itemsMember])
									}
								}
							}
							if (!this._valueList) {
						...
						ensureVisible : function(d) {
							...
							if (this.panel) {
								var c = this.panel
										.jqxPanel("getVScrollPosition");
								var e = this.panel
										.jqxPanel("getHScrollPosition");
								var b = parseInt(this.host.height());
								var f = a(d).position().top;
								if (f <= c || f >= b + c) {
									this.panel.jqxPanel("scrollTo", e, f - b
											+ a(d).outerHeight())
								}
							}
						},
							...
							var e = function(j) {
								...
								if (p.selectedItem != null) {
									...
									a(p.selectedItem.titleElement)
											.addClass(
													p
															.toThemeProperty("jqx-tree-item-selected"))
								}
							};
							if (n == false) {
								e(true);
						...
						addTo : function(q, s, p) {
							...
							if (s == undefined && s == null) {
								...
								if (e.length == 0) {
									...
									e
											.addClass(n
													.toThemeProperty("jqx-tree-dropdown"));
									if (r.rtl) {
										e
												.addClass(n
														.toThemeProperty("jqx-tree-dropdown-rtl"))
									}
									e.append(b);
						...
						updateItem : function(e, j) {
							var h = e.treeInstance != undefined ? e : this
									.getItem(e);
							if (!h) {
								var d = e;
								e = j;
							...
							if (h) {
								...
								if (j.label) {
									h.label = j.label;
									a.jqx.utilities.html(a(h.titleElement),
											j.label);
									var b = a.jqx.browser.msie
											&& a.jqx.browser.version < 8;
									if (b) {
										a(document.body).append(
												this._measureItem);
										this._measureItem
												.html(a(h.titleElement).text());
										...
										a(h.titleElement).css("max-width",
												g + "px");
											...
											function() {
												...
												if (d.element == b) {
													...
													a(d.titleElement)
															.addClass(
																	c
																			.toThemeProperty("jqx-tree-item-disabled"));
													if (c.checkboxes
															&& d.checkBoxElement) {
														a(d.checkBoxElement)
																.jqxCheckBox(
						...
						selectItem : function(b, c) {
							...
							if (this.selectedItem != null
									&& this.selectedItem.element == b) {
								return
							}
							var e = this.selectedItem != null ? this.selectedItem.element
									: null;
							if (e) {
									...
									.each(
											...
											function() {
												...
												if (!f.disabled) {
													if (f.element == b) {
														if (d.selectedItem == null
																|| (d.selectedItem != null && d.selectedItem.titleElement != f.titleElement)) {
															if (d.selectedItem != null) {
																a(
																		d.selectedItem.titleElement)
																		.removeClass(
																				d
																						.toThemeProperty("jqx-fill-state-pressed"));
																a(
						...
						expandItem : function(b) {
							...
							a.each(c.items, function() {
								var d = this;
								if (d.isExpanded == false && d.element == b
										&& !d.disabled && !d.locked) {
									c._expandItem(c, d);
									if (d.parentElement) {
						...
						_expandItem : function(g, k) {
							...
							e.slideDown(g.animationShowDuration, g.easing,
									function() {
										var l = a(k.arrow);
										k.isExpanded = true;
						...
						_calculateWidth : function() {
							...
							a.each(this.items, function() {
								...
								if (h != 0) {
									var l = a(this.titleElement).outerWidth()
											+ 10 + g + (1 + this.level) * 20;
									e = Math.max(e, l);
									if (this.hasItems) {
										var j = parseInt(a(this.titleElement)
												.css("padding-top"));
										if (isNaN(j)) {
											j = 0
										}
										j = j * 2;
										j += 2;
										var k = (j + a(this.titleElement)
												.height()) / 2 - 17 / 2;
										if (a.jqx.browser.msie
												&& a.jqx.browser.version < 9) {
											a(this.arrow).css("margin-top",
													"3px")
										} else {
											if (parseInt(k) >= 0) {
												a(this.arrow).css("margin-top",
							...
							if (f.panel) {
								if (e > this.host.width()) {
									...
									var d = f.panel.jqxPanel("vScrollBar").css(
							...
							a
									.each(
											...
											function() {
												...
												$element = a(m.element);
												var k = null;
												if (e.checkboxes && !m.hasItems
														&& m.checkBoxElement) {
													a(m.checkBoxElement).css(
															"margin-left",
															"0px")
												}
												if (!b) {
													if (!m.hasItems) {
														if (!e.rtl) {
															m.element.style.marginLeft = parseInt(e.toggleIndicatorSize)
																	+ "px"
														} else {
															m.element.style.marginRight = parseInt(e.toggleIndicatorSize)
																	+ "px"
														}
														var j = a(m.arrow);
														if (j.length > 0) {
												...
												k = a('<span style="height: 17px; border: none; background-color: transparent;" id="arrow'
														+ $element[0].id
														+ '"></span>');
												k.prependTo($element);
												if (!e.rtl) {
												...
												e.addHandler(k, "selectstart",
														function() {
															return false
														});
												e.addHandler(k, "mouseup",
														function() {
															if (!h) {
																return false
															}
														});
												m.hasItems = a(m.element).find(
														"li").length > 0;
												m.arrow = k[0];
												if (!m.hasItems) {
													k.css("visibility",
										...
										.addHandler(
												...
												function() {
													if (!e.disabled
														...
														f
																.addClass(d
																		.toThemeProperty("jqx-tree-item-hover"))
													}
												});
								d
										.addHandler(
						...
						_render : function(f, j) {
							if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
								...
								a.each(this.items, function() {
									...
									var p = n.parent();
									var m = parseInt(this.titleElement
											.css("margin-left"))
							...
							var c = [ 5, 5 ];
							var g = this;
							a.data(g.element, "animationHideDelay",
									g.animationHideDelay);
							...
							if (this.host.jqxPanel) {
								...
								if (this.height == null
									...
									if (this.isTouchDevice()) {
										...
										this.removeHandler(b, a.jqx.mobile
								...
								if (a.jqx.browser.msie
									...
									this.host.find("div").attr("hideFocus",
											true);
									this.host.find("ul")
											.attr("hideFocus", true)
								}
						...
						_updateItemEvents : function(h, k) {
							...
							var e = !b ? "mousedown" : a.jqx.mobile
									.getTouchEventName("touchend");
							if (h.touchMode === true) {
								h.removeHandler(a(k.checkBoxElement),
										"mousedown")
							}
						...
						createTree : function(b) {
							...
							a(b)
									.addClass(
											d
													.toThemeProperty("jqx-tree-dropdown-root"));
							if (this.rtl) {
								a(b)
										.addClass(
												d
														.toThemeProperty("jqx-tree-dropdown-root-rtl"))
							}
							if (this.rtl || a.jqx.browser.msie
									&& a.jqx.browser.version < 8) {
								this._measureItem = a("<span style='position: relative; visibility: hidden;'></span>");
								this._measureItem.addClass(this
										.toThemeProperty("jqx-widget"));
								this._measureItem
										.addClass(this
												.toThemeProperty("jqx-fill-state-normal"));
								this._measureItem.addClass(this
										.toThemeProperty("jqx-tree-item"));
								this._measureItem.addClass(this
						...
						_updateCheckItemLayout : function(b) {
							if (this.checkboxes) {
								if (a(b.titleElement).css("display") != "none") {
									...
									var d = a(b.titleElement).outerHeight() / 2
											- 1 - parseInt(this.checkSize) / 2;
									c.css("margin-top", d);
									if (!this.rtl) {
										if (a.jqx.browser.msie
												&& a.jqx.browser.version < 8) {
								...
								if (this.itemMapping["id" + b.id]) {
									...
									if (d > 0) {
										if (this.itemMapping["id" + f[d - 1].id]) {
											e.prevItem = this.itemMapping["id"
													+ f[d - 1].id].item
										}
									}
									if (d < f.length - 1) {
										if (this.itemMapping["id" + f[d + 1].id]) {
											e.nextItem = this.itemMapping["id"
													+ f[d + 1].id].item
										}
									}
								}
						...
						_applyTheme : function(e, h) {
							...
							var b = this.host.find("ul:first");
							a(b).removeClass(
									f.toThemeProperty("jqx-tree-dropdown-root-"
											+ e));
							a(b)
									.addClass(
											f
							...
							a
									.each(
											...
											function() {
												...
												k
														.removeClass(f
																.toThemeProperty("jqx-tree-item-li-"
																		+ e));
												k
														.addClass(f
																.toThemeProperty("jqx-tree-item-li"));
						...
						_refreshMapping : function(f, q) {
							...
							for (var j = 0; j < e.length; j++) {
								...
								var n = null;
								var g = null;
								if (o.titleElement[0].className
										.indexOf("jqx-fill-state-pressed") != -1) {
									a(o.titleElement)
											.removeClass(
													l
															.toThemeProperty("jqx-fill-state-pressed"));
						...
						_createItem : function(c) {
							...
							if (!h || !E) {
								if (a(F.firstChild).length > 0) {
									...
									if (b == -1) {
										...
										F.innerHTML = '<div style="display: inline-block;">'
												+ F.innerHTML + "</div>";
										...
										B = a.trim(B);
										C.originalTitle = B;
										B = a('<div style="display: inline-block;">'
												+ B + "</div>");
									...
									if (a.jqx.browser.msie
											&& a.jqx.browser.version < 8) {
										a(a(F)[0].firstChild).css("display",
												"inline-block");
										var n = false;
										...
										this._measureItem.css("min-width",
												"20px");
										this._measureItem[0].innerHTML = (a(C.titleElement)
												.text());
										...
										a(a(F)[0].firstChild).css("max-width",
												u + "px");
										if (n) {
											this._measureItem.remove()
										}
							...
							a(F).addClass(
									this.toThemeProperty("jqx-tree-item-li"));
							if (this.rtl) {
								a(F)
										.addClass(
												this
														.toThemeProperty("jqx-tree-item-li-rtl"))
							}
							q += " " + this.toThemeProperty("jqx-tree-item")
									+ " " + this.toThemeProperty("jqx-item");
							if (this.rtl) {
								q += " "
										+ this
												.toThemeProperty("jqx-tree-item-rtl")
							}
						...
						destroy : function() {
							this.removeHandler(a(window), "resize.jqxtree"
									+ this.element.id);
								...
								this
										.removeHandler(
												...
												a.jqx.mobile
														.getTouchEventName("touchend")
														+ ".touchScroll touchcancel.touchScroll");
								this.removeHandler(this.panel, a.jqx.mobile
										.getTouchEventName("touchmove")
										+ ".touchScroll");
								this.removeHandler(this.panel, a.jqx.mobile
										.getTouchEventName("touchstart")
												...
												.each(
														...
														function() {
															for (var n = 0; n < m.length; n++) {
																if (m[n].label == this.label
																		&& m[n].level == this.level) {
																	var o = h
																			.getItem(this.element);
																	h
																			._expandItem(
																					h,
																					o)
